...
let face = "body part that connects to the rest of your body allowing you to view the world through sight, smell, etc. "; /*Between the quotation marks, 
...
let red = "the color of a rose, the color of romance, the color of blood"; //repeat the instructions with the word "red" (keep in the form of a noun)

let brain = "a hub that stores knowledge and receives information from our nerves to determine how we read information"; //repeat the instructions for the word "brain"

let masculine = "blue, manly, rough, emotionless, competitive"; //define 'masculine' in ADJECCTIVE form, so 
//you could sub it into a sentence that uses the word as an ADJECTIVE

let think = "a way processing, hearing, seeing, and imagining information"; //define 'think' in VERB form,
